...
#Uninstall
Remove-Item "C:\ProgramData\Autodesk\Revit\Addins\2017\XPORT.addin" -ErrorAction Ignore
...
Remove-Item "C:\ProgramData\Autodesk\Revit\Addins\2017\XPORT" -Recurse -ErrorAction Ignore
...
#REVIT 2017
New-Item "C:\ProgramData\Autodesk\Revit\Addins\2017\XPORT" -ItemType directory
Copy-Item "2017\XPORT\XP.png" "C:\ProgramData\Autodesk\Revit\Addins\2017\XPORT"
Copy-Item "2017\XPORT\XPORT.dll" "C:\ProgramData\Autodesk\Revit\Addins\2017\XPORT"
Copy-Item "2017\XPORT.addin" "C:\ProgramData\Autodesk\Revit\Addins\2017"
#REVIT 2018
